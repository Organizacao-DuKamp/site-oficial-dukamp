...
const CUSTOMER_SELLER_FILTER_OPTIONS = `295|ADRIANA JOSUE;352|ALBERTO SOARES SOUZA JUNIOR;037|ALESSANDRO AUGUSTO DA SILVA;366|ALESSANDRO BRAGGE MARCOLINO;721|ALEXANDRE LUIS DE MELO FILHO;417|AMANDA APARECIDA;371|ANA LUIZA;208|ANDRESSA MARTINS DE SOUZA;414|ANTONIO MANTOVAN E CIA LTDA;720|BARBARA CRISTINA DEL MORO SILVA;065|BRENDA;340|BRENO RENESTO SOUBHIA;716|BRUNA ALDREN GRANDI;715|BRUNO FERNANDO FERREIRA DIAS;930|BRUNO FILIAL PACOTE;396|CARLOS HENRIQUE GIRARDI;327|CAROLINE FERNANDA CARVALHO;268|CASSIANO DE OLIVEIRA LOCATELLI;719|DANIELE ARANTES TURRIONI;389|DANIELLE LOPES DOMINE;370|DANILO LEITE;075|DEBORA;717|DEBORA DEFINA DA SILVA SOUZA;416|DIESGNEO FURTADO DA COSTA;712|DUDA VEND RIO PRETO;001|DUKAMP (VENDEDOR);392|EDUARDO FARIA;388|ENEIAS NEVES OLIVEIRA;183|FAT.CARGAS;722|FERNANDO / NUCLEO;002|FILIAL;069|FLAVIO MANO HAKME;101|FORA VENDA;391|FRANCISCO GAUDENCIO DE MACEDO;379|G.DANI DA COSTA;378|G.LUIZ DA SILVA FERNANDES;347|GABRIEL;333|GABRIELA PACHECO RODRIGUES;411|GERALDO EUSTAQUI FERREIRA;207|GERVAZIO DA SILVEIRA TEODORO;402|GUSTAVO HENRIQUE BAUEB;364|GUSTAVO HENRIQUE MARCATO;368|HEITOR;013|ILDENEA DE OLIVEIRA TASSONI;365|INGRID;386|ISABELA MODESTO;409|JANAINA DA SILVA OLIVEIRA;374|JAYNE;395|JOAO CARLOS PASCUTI;030|JOSE JUSTINO ESPLENDOR;269|KHRISTIAN TEIXEIRA DE FREITAS;380|LELO MAZETI;925|LEONARDO RECHE;383|LORENA;713|LORENA VEND RIO PRETO;317|LUCAS VINICIUS;367|MANEJO SOLUCOES AGROPECUARIAS;129|MARCO ANTONIO SARTORI;077|MARCOS ROBERTO GUIMARAES;714|MARCUS PAULO LEMOS VILELA;711|MARIA VEND RIO PRETO;936|MARIANA;387|MAYSA BORGUEZAN MELO SANCHES;201|MEIO;363|MICHELLY MENEGASSI CRUZ;415|MICHELY;385|MIGUEL PEDROSO;137|MS PARCERIA;418|MURILO SPOLON;012|NATA;919|NATASHA;401|NELSON JAMIL RODRIGUES;320|OSVALDO RIBEIRO DOS SANTOS JUNIOR;312|OSVANI PEREIRA MACHADO;377|P.IVO COUTINHO DE SOUZA;124|P.LEMOS (PAULO LEMOS);109|PEDRO HENRIQUE MARQUES DE OLIVEIRA;369|PIETRA;076|PRISCILA SIVIDANES;708|RAFAEL LAURENCE MARQUES;034|RAFAELA CRISTINA;375|RENATHIELY;408|RENATO GAUY SILVA;394|RITA DE CASSIA DE PAULA;723|RODRIFERTIL - NOVO HORIZONTE;399|RODRIGO ABI RACHED;382|ROGERIO;023|ROGERIO CEZAR GOMES DE REZENDE;346|SARAH;398|SILES VANDERLEI CALANDRIA;313|SITE DUKAMP;390|STEFANY FERNANDA AMANCIO;397|TIAGO POTENZA LINHARES;376|TUTINHA (ORLANDO CORTOPASSI NETO);911|VITINHO;372|VITINHO (VICTOR FERRAREZI);410|VIVIANE CRISTINA DOMINGUES`
  .split(";")
  .map((entry) => {
    const [value, ...nameParts] = entry.split("|");
    return { value, label: `${value} - ${nameParts.join("|")}` };
  });
        ...
        filters={[
          {
            ...
            label: "Vendedor / último vendedor",
            options: [...CUSTOMER_SELLER_FILTER_OPTIONS],
          },
        ]}
        columns={[
