  ...
  return (
    <div
      className={
        ...
        (onSale
          ? "border-2 border-[#0B2E59] shadow-md hover:shadow-lg"
          : "border hover:shadow-lg")
      }
    >
      {onSale && (
        <div className="absolute top-2 left-2 z-20 rounded-full bg-[#0B2E59] px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider text-white shadow">
      ...
      <div className="p-3 flex-1 flex flex-col justify-between gap-3">
        ...
        <div className="space-y-0.5 text-center">
          ...
          <div className={"text-xl font-bold " + (onSale ? "text-[#0B2E59]" : "text-foreground")}>{formatBRL(displayPrice)}</div>
          {displayPix != null && (
